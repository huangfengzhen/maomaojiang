...
var Zepto = function () {
    ...
    T.qsa = function (t, e) {
        ...
        s = i || r ? e.slice(1)  : e,
        a = E.test(s);
        return _(t) && a && i ? (n = t.getElementById(s)) ? [
            n
        ] : [
    ...
    n.fn = {
        ...
        parents: function (t) {
            for (var e = [
            ], i = this; i.length > 0; ) i = n.map(i, function (t) {
        ...
        return e && !o(e) ? (t.each(e, function (t, e) {
            ...
            s && (l = function (e) {
                ...
                return o && o !== r ? (n = t.extend(S(e), {
                    ...
                    n
                ].concat(i.call(arguments, 1))))  : void 0
            }),
            v(r, e, u, a, s, l || c)
        }))
    },
...
function (t) {
    ...
    function m(t, e) {
        var n = e.context;
        return e.beforeSend.call(n, t, e) === !1 || h(e, n, 'ajaxBeforeSend', [
            t,
            e
        ]) === !1 ? !1 : void h(e, n, 'ajaxSend', [
            t,
            e
        ])
    }
